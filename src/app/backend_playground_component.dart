...
final class BackendSetBusy extends BackendPlaygroundAction {
  const BackendSetBusy({required this.busy, this.action});
  final bool busy;
  final String? action;
}
...
BackendPlaygroundState backendPlaygroundReducer(
  ...
  return switch (action) {
    BackendSetBusy(busy: final b, action: final a) => state.copyWith(
        busy: b,
        busyAction: b ? a : null,
      ),
...
final class BackendPlaygroundComponent extends Component {
  ...
  static const _idPasswordResetNewPassword =
      'backend-password-reset-new-password';
  ...
  web.Element render() {
    ...
    final disabledForAction =
        (String action) => state.busy && state.busyAction == action;
    ...
    useEffect('seedBaseUrlInput', [state.baseUrl], () {
      ...
      if (input != null && input.value.trim().isEmpty)
    ...
    return dom.div(
        ...
        children: [
          ...
          dom.section(
            ...
            children: [
              ...
              dom.row(children: [
                ...
                dom.secondaryButton(
                  'Use base URL',
                  action: 'backend-set-base',
                  disabled: disabledForAction('backend-set-base'),
                ),
              ]),
              dom.spacer(),
              dom.statusText(
                  text: state.status,
                  isError: state.status.toLowerCase().contains('error')),
          ...
          dom.section(
            title: 'Auth',
            subtitle:
                'Bootstrap (first user), demo bootstrap, login, logout, /me.',
            children: [
              dom.spacer(),
              dom.row(children: [
                ...
                dom.primaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.bootstrap),
                ),
                dom.secondaryButton(
                  'Demo bootstrap + login',
                  action: BackendDomActions.demoBootstrap,
                  disabled: disabledForAction(BackendDomActions.demoBootstrap),
                ),
                dom.primaryButton(
                  'Login',
                  action: BackendDomActions.login,
                  disabled: disabledForAction(BackendDomActions.login),
                ),
                dom.secondaryButton(
                  'Logout',
                  action: BackendDomActions.logout,
                  disabled: disabledForAction(BackendDomActions.logout),
                ),
                dom.secondaryButton(
                  'GET /me',
                  action: BackendDomActions.refreshMe,
                  disabled: disabledForAction(BackendDomActions.refreshMe),
                ),
              ]),
            ],
          ),
            ...
            children: [
              ...
              dom.row(children: [
                dom.secondaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.listTenants),
                ),
                inputText(
                    id: _idTenantSlug, placeholder: 'tenant slug (default)'),
                dom.primaryButton(
                  'Select tenant',
                  action: BackendDomActions.selectTenant,
                  disabled: disabledForAction(BackendDomActions.selectTenant),
                ),
                dom.secondaryButton(
                  'GET /t/<slug>/me',
                  action: BackendDomActions.tenantMe,
                  disabled: disabledForAction(BackendDomActions.tenantMe),
                ),
              ]),
              if (state.activeTenantSlug != null)
                dom.muted('Active tenant slug: ${state.activeTenantSlug}'),
            ],
          ),
          dom.spacer(),
          dom.section(
            ...
            children: [
              ...
              dom.row(children: [
                dom.secondaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.listSessions),
                ),
                dom.dangerButton(
                  'Revoke others',
                  action: BackendDomActions.revokeOthers,
                  disabled: disabledForAction(BackendDomActions.revokeOthers),
                ),
              ]),
            ],
          ),
          ...
          dom.section(
            title: '2FA (TOTP)',
            subtitle:
                'Enroll + confirm, then verify (after login if required).',
            children: [
              dom.spacer(),
              dom.row(children: [
                dom.primaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.enroll2faStart),
                ),
                ...
                dom.primaryButton(
                  ...
                  disabled:
                      disabledForAction(BackendDomActions.enroll2faConfirm),
                ),
              ]),
              dom.spacer(),
              if (state.totpSecret != null)
                dom.muted('Secret: ${state.totpSecret}'),
              ...
              dom.row(children: [
                ...
                dom.primaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.verify2fa),
                ),
                dom.dangerButton(
                  'Disable 2FA',
                  action: BackendDomActions.disable2fa,
                  disabled: disabledForAction(BackendDomActions.disable2fa),
                ),
              ]),
            ],
          ),
            ...
            children: [
              ...
              dom.row(children: [
                dom.primaryButton(
                  ...
                  disabled:
                      disabledForAction(BackendDomActions.emailVerifyRequest),
                ),
                inputText(id: _idEmailVerifyToken, placeholder: 'verify token'),
                dom.primaryButton(
                  'Verify',
                  action: BackendDomActions.emailVerify,
                  disabled: disabledForAction(BackendDomActions.emailVerify),
                ),
              ]),
            ],
          ),
            ...
            children: [
              ...
              dom.row(children: [
                ...
                dom.primaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.passwordForgot),
                ),
              ]),
              dom.spacer(),
              dom.row(children: [
                inputText(
                    id: _idPasswordResetToken, placeholder: 'reset token'),
                inputPassword(
                    id: _idPasswordResetNewPassword,
                    placeholder: 'new password'),
                dom.primaryButton(
                  'Reset',
                  action: BackendDomActions.passwordReset,
                  disabled: disabledForAction(BackendDomActions.passwordReset),
                ),
              ]),
            ],
          ),
          ...
          dom.section(
            title: 'Invites',
            subtitle:
                'Create invite (admin) and accept it (new or existing user).',
            children: [
              dom.spacer(),
              dom.row(children: [
                inputText(
                    id: _idInviteTenantSlug,
                ...
                dom.primaryButton(
                  ...
                  disabled: disabledForAction(BackendDomActions.inviteCreate),
                ),
              ]),
              dom.spacer(),
              dom.row(children: [
                inputText(
                    id: _idInviteAcceptTenantSlug,
                    placeholder: 'tenant slug (e.g. acme)'),
                inputText(id: _idInviteToken, placeholder: 'invite token'),
                inputPassword(
                    id: _idInvitePassword,
                    placeholder: 'password (for new user)'),
                dom.primaryButton(
                  'Accept (new user)',
                  action: BackendDomActions.inviteAccept,
                  disabled: disabledForAction(BackendDomActions.inviteAccept),
                ),
                dom.primaryButton(
                  'Accept (existing)',
                  action: BackendDomActions.inviteAcceptExisting,
                  disabled:
                      disabledForAction(BackendDomActions.inviteAcceptExisting),
                ),
              ]),
            ],
          ),
  ...
  void _onClick(web.MouseEvent event) {
    dispatchAction(event, {
      ...
      BackendDomActions.bootstrap: (_) =>
          _runAction(BackendDomActions.bootstrap, _bootstrap),
      BackendDomActions.demoBootstrap: (_) =>
          _runAction(BackendDomActions.demoBootstrap, _demoBootstrapAndLogin),
      BackendDomActions.login: (_) =>
          _runAction(BackendDomActions.login, _login),
      BackendDomActions.logout: (_) =>
          _runAction(BackendDomActions.logout, _logout),
      BackendDomActions.refreshMe: (_) =>
          _runAction(BackendDomActions.refreshMe, _me),
      BackendDomActions.listTenants: (_) =>
          _runAction(BackendDomActions.listTenants, _tenants),
      BackendDomActions.selectTenant: (_) =>
          _runAction(BackendDomActions.selectTenant, _selectTenant),
      BackendDomActions.tenantMe: (_) =>
          _runAction(BackendDomActions.tenantMe, _tenantMe),
      BackendDomActions.listSessions: (_) =>
          _runAction(BackendDomActions.listSessions, _sessions),
      BackendDomActions.revokeOthers: (_) =>
          _runAction(BackendDomActions.revokeOthers, _revokeOthers),
      BackendDomActions.enroll2faStart: (_) =>
          _runAction(BackendDomActions.enroll2faStart, _enroll2faStart),
      BackendDomActions.enroll2faConfirm: (_) =>
          _runAction(BackendDomActions.enroll2faConfirm, _enroll2faConfirm),
      BackendDomActions.verify2fa: (_) =>
          _runAction(BackendDomActions.verify2fa, _verify2fa),
      BackendDomActions.disable2fa: (_) =>
          _runAction(BackendDomActions.disable2fa, _disable2fa),
      BackendDomActions.emailVerifyRequest: (_) =>
          _runAction(BackendDomActions.emailVerifyRequest, _emailVerifyRequest),
      BackendDomActions.emailVerify: (_) =>
          _runAction(BackendDomActions.emailVerify, _emailVerify),
      BackendDomActions.passwordForgot: (_) =>
          _runAction(BackendDomActions.passwordForgot, _passwordForgot),
      BackendDomActions.passwordReset: (_) =>
          _runAction(BackendDomActions.passwordReset, _passwordReset),
      BackendDomActions.inviteCreate: (_) =>
          _runAction(BackendDomActions.inviteCreate, _inviteCreate),
      BackendDomActions.inviteAccept: (_) =>
          _runAction(BackendDomActions.inviteAccept, _inviteAccept),
      BackendDomActions.inviteAcceptExisting: (_) => _runAction(
          BackendDomActions.inviteAcceptExisting, _inviteAcceptExisting),
    });
  }
  ...
  Future<void> _runAction(
    ...
    _store.dispatch(BackendSetBusy(busy: true, action: actionName));
    ...
    try {
      ...
      _store.dispatch(const BackendSetBusy(busy: false));
    }
  }
  ...
  Future<void> _bootstrap() async {
    ...
    final res = await _api
        .postJson('/bootstrap', {'email': email, 'password': password});
    _setLastJson(res);
  ...
  Future<void> _login() async {
    ...
    final password = _value(_idPassword);
    final res =
        await _api.postJson('/login', {'email': email, 'password': password});
  ...
  Future<void> _selectTenant() async {
    ...
    final res =
        await _api.postJson('/tenants/select', {'slug': slug}, csrf: true);
  ...
  Future<void> _enroll2faConfirm() async {
    ...
    final res =
        await _api.postJson('/mfa/enroll/confirm', {'code': code}, csrf: true);
    _setLastJson(res);
  ...
  Future<void> _passwordReset() async {
    ...
    _setLastJson(res);
    _store.dispatch(
        const BackendSetStatus('Password reset complete (sessions revoked).'));
  }

  Future<void> _inviteCreate() async {
    final tenantSlug = _value(_idInviteTenantSlug).isEmpty
        ? 'default'
        : _value(_idInviteTenantSlug);
  ...
  Future<void> _inviteAccept() async {
    final tenantSlug = _value(_idInviteAcceptTenantSlug).isEmpty
        ? 'default'
        : _value(_idInviteAcceptTenantSlug);
